            ...
            <main className="flex-1 space-y-6 p-6">
                ...
                <div className="relative overflow-hidden rounded-2xl bg-[#16241c] p-6">
                    ...
                    <div className="relative flex flex-wrap items-center justify-between gap-4">
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 rounded-full bg-[#b98a2e] px-5 py-2.5 font-['Space_Grotesk'] text-sm font-medium text-[#16241c] transition hover:bg-[#c99a3e]"
                        >
                        ...
                        return (
                            ...
                            >
                                <div className="flex items-center justify-between">
                                    ...
                                    <span
                                        className={`flex items-center gap-0.5 font-['IBM_Plex_Mono'] text-xs font-medium ${
                                            stat.trend === 'up'
                                                ? 'text-[#16A34A]'
                                                : 'text-[#B98A2E]'
                                        }`}
                ...
                <div className="grid gap-6 lg:grid-cols-[1.4fr_1fr]">
                    ...
                    <div className="rounded-2xl bg-white p-6 ring-1 ring-[#14172B]/5 dark:bg-white/5 dark:ring-white/10">
                        ...
                        {trendData.length === 0 ? (
                            ...
                            <div className="mt-16 flex h-50 items-end gap-2 rounded-lg bg-gray-100 p-3 dark:bg-white/5">
                ...
                <div className="rounded-2xl bg-white p-6 ring-1 ring-[#14172B]/5 dark:bg-white/5 dark:ring-white/10">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <a
                            href="/payroll-runs"
                            className="font-['Space_Grotesk'] text-xs font-medium text-[#16241c] hover:underline dark:text-white"
                        >
                            View all
                        </a>
                            ...
                            <tbody>
                                ...
                                {payRuns?.length > 0 ? (
                                    ...
                                    payRuns.map((run) => (
                                        ...
                                        >
                                            ...
                                            <td className="py-3">
                                                ...
                                                <span
                                                    className={`rounded-full px-2.5 py-1 font-['Space_Grotesk'] text-xs font-medium ${
                                                        statusStyle[
                                                            run.status
                                                        ] ??
                                    ...
                                    <tr>
                                        ...
                                        <td
                                            colSpan={4}
                                            className="py-8 text-center font-['Space_Grotesk'] text-sm text-[#14172B]/40 dark:text-white/40"
                                        >
                                            No recent pay runs available.
                                        </td>
